...
#define GLOBAL_BPT_MID_8K 0x00000001
#define GLOBAL_BPT_MAX_8K 0x00000003

/* For budget 16K */
#define GLOBAL_SIZE_16K 1024
#define GLOBAL_BPT_IDX_MAX_16K 0x000003ff
#define GLOBAL_BPT_MID_16K 0x00000001
#define GLOBAL_BPT_MAX_16K 0x00000003

/* For budget 32K */
#define GLOBAL_SIZE_32K 2048
#define GLOBAL_BPT_IDX_MAX_32K 0x000007ff
#define GLOBAL_BPT_MID_32K 0x00000001
#define GLOBAL_BPT_MAX_32K 0x00000003

/* for budget 64K */
#define GLOBAL_SIZE_64K 4096
#define GLOBAL_BPT_IDX_MAX_64K 0x00000fff
#define GLOBAL_BPT_MID_64K 0x00000001
#define GLOBAL_BPT_MAX_64K 0x00000003

/* For budget 128K */
#define GLOBAL_SIZE_128K 8192
#define GLOBAL_BPT_IDX_MAX_128K 0x00001fff
#define GLOBAL_BPT_MID_128K 0x00000001
#define GLOBAL_BPT_MAX_128K 0x00000003

/* For budget 1M */
#define GLOBAL_SIZE_1M 65536
#define GLOBAL_BPT_IDX_MAX_1M 0x0000ffff
#define GLOBAL_BPT_MID_1M 0x00000001
#define GLOBAL_BPT_MAX_1M 0x00000003
