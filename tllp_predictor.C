...
static void tllp_set_budget_constants(budget_size budget)
{
	switch (budget) {
		case BUDGET_8K:
			tllp_lht_size		= TLLP_LHT_SIZE_8K;
			tllp_bpt_size		= TLLP_BPT_SIZE_8K;
			tllp_bpt_mid		= TLLP_BPT_MID_8K;
			tllp_bpt_max		= TLLP_BPT_MAX_8K;
			tllp_bpt_idx_max	= TLLP_BPT_IDX_MAX_8K;
			tllp_lht_idx_max	= TLLP_LHT_IDX_MAX_8K;
			tllp_lht			= tllp.lht.b8k;
			tllp_bpt			= tllp.bpt.b8k;
			break;

		case BUDGET_16K:
			tllp_lht_size		= TLLP_LHT_SIZE_16K;
			tllp_bpt_size		= TLLP_BPT_SIZE_16K;
			tllp_bpt_mid		= TLLP_BPT_MID_16K;
			tllp_bpt_max		= TLLP_BPT_MAX_16K;
			tllp_bpt_idx_max	= TLLP_BPT_IDX_MAX_16K;
			tllp_lht_idx_max	= TLLP_LHT_IDX_MAX_16K;
			tllp_lht			= tllp.lht.b16k;
			tllp_bpt			= tllp.bpt.b16k;
			break;

		case BUDGET_32K:
			tllp_lht_size		= TLLP_LHT_SIZE_32K;
			tllp_bpt_size		= TLLP_BPT_SIZE_32K;
			tllp_bpt_mid		= TLLP_BPT_MID_32K;
			tllp_bpt_max		= TLLP_BPT_MAX_32K;
			tllp_bpt_idx_max	= TLLP_BPT_IDX_MAX_32K;
			tllp_lht_idx_max	= TLLP_LHT_IDX_MAX_32K;
			tllp_lht			= tllp.lht.b32k;
			tllp_bpt			= tllp.bpt.b32k;
			break;

		case BUDGET_64K:
			tllp_lht_size		= TLLP_LHT_SIZE_64K;
			tllp_bpt_size		= TLLP_BPT_SIZE_64K;
			tllp_bpt_mid		= TLLP_BPT_MID_64K;
			tllp_bpt_max		= TLLP_BPT_MAX_64K;
			tllp_bpt_idx_max	= TLLP_BPT_IDX_MAX_64K;
			tllp_lht_idx_max	= TLLP_LHT_IDX_MAX_64K;
			tllp_lht			= tllp.lht.b64k;
			tllp_bpt			= tllp.bpt.b64k;
			break;

		case BUDGET_128K:
			tllp_lht_size		= TLLP_LHT_SIZE_128K;
			tllp_bpt_size		= TLLP_BPT_SIZE_128K;
			tllp_bpt_mid		= TLLP_BPT_MID_128K;
			tllp_bpt_max		= TLLP_BPT_MAX_128K;
			tllp_bpt_idx_max	= TLLP_BPT_IDX_MAX_128K;
			tllp_lht_idx_max	= TLLP_LHT_IDX_MAX_128K;
			tllp_lht			= tllp.lht.b128k;
			tllp_bpt			= tllp.bpt.b128k;
			break;

		case BUDGET_1M:
			tllp_lht_size		= TLLP_LHT_SIZE_1M;
			tllp_bpt_size		= TLLP_BPT_SIZE_1M;
			tllp_bpt_mid		= TLLP_BPT_MID_1M;
			tllp_bpt_max		= TLLP_BPT_MAX_1M;
			tllp_bpt_idx_max	= TLLP_BPT_IDX_MAX_1M;
			tllp_lht_idx_max	= TLLP_LHT_IDX_MAX_1M;
...
{
	unsigned int lsb_addr = (pc & tllp_lht_idx_max);
